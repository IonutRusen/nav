...
(function ($) {
    ...
    $.fn.fileinputLocales['ro'] = {
        ...
        dropZoneClickTitle: '<br>(sau click pentru alegere {files})',
        fileActionSettings: {
            removeTitle: 'Scoateți fișier',
            uploadTitle: 'Incarca fisier',
            uploadRetryTitle: 'Reincearca upload',
            downloadTitle: 'Descarca file',
            zoomTitle: 'Vezi detalii',
            dragTitle: 'Muta / Rearanjeaza',
            indicatorNewTitle: 'Nu a încărcat încă',
            indicatorSuccessTitle: 'încărcat',
            indicatorErrorTitle: 'Încărcați eroare',
            indicatorPausedTitle: 'Pauza la incarcare',
            indicatorLoadingTitle:  'Se încarcă ...'
        },
        previewZoomButtonTitles: {
            prev: 'Vezi fisierul precedent',
            next: 'Vezi fisierul urmator',
            toggleheader: 'Arata header',
            fullscreen: 'Ecran intreg',
            borderless: 'Toggle borderless mode',
            close: 'Inchide previzualizarea'
        }
    };
})(window.jQuery);
